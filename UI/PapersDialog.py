...
from data.sql import get_papers_table


class PapersDialog(QDialog):
    def __init__(self):
        super().__init__()
        self.initUI()

    def initUI(self):
        self.setWindowTitle('所有试卷')
    ...
    def load_papers_table(self):
        rows, descriptions = get_papers_table()
